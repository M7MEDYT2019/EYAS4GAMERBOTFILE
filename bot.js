...
client.on("message", message => {
 if (message.content === "-support") {
  const embed = new Discord.RichEmbed()
      .setColor("RANDOM")
      .setFooter('© EYA4SGAMER BOT:heart: جميع حقوق البوت 2018')  
      .addField('سيرفر الدعم الفني', ` https://discord.gg/BM2n7f  `)
  message.author.send({embed});
...
client.on("message", message => {
   ...
   if(!message.member.hasPermission('MANAGE_MESSAGES')) return message.reply('⚠ | *** ⚠ لا يوجد لك مانج ماسج ***');
      ...
      message.channel.sendMessage("", {embed: {
        ...
        footer: {
          text: "© EYA4SGAMER BOT:heart: جميع حقوق البوت 2018"
        }
...
client.login("NDcyMDk1NTg0NjEwNjgwODYy.DlTanw.lGR6PDuGy8jMd4iSKWURl_kLQzc");
